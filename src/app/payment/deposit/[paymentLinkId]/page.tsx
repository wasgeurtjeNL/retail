...
// Deposit payment pagina voor Wasstrips aanbetaling
export default function DepositPaymentPage() {
  ...
  useEffect(() => {
    if (paymentLinkId) {
      ...
      setPaymentInfo({
        amount: 30.00,
        description: 'Wasstrips Aanbetaling',
        paymentLinkId
      });
      setLoading(false);
    }
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-pink-600 px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-white">Wasstrips Aanbetaling</h1>
                <p className="text-pink-100 mt-1">Betaling voor uw Wasstrips bestelling</p>
              </div>
              {isTestMode && (
          ...
          <div className="px-6 py-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Betalingsdetails</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">{paymentInfo.description}</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="space-y-4 mb-8">
              ...
              <button 
                ...
                className="w-full bg-pink-600 hover:bg-pink-700 disabled:bg-pink-400 text-white font-semibold py-4 px-6 rounded-lg transition-colors flex items-center justify-center space-x-3"
              >
                {processingPayment ? (
                  <>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-blue-900 mb-1">Wat gebeurt er na betaling?</h4>
                  <ul className="text-blue-800 text-sm space-y-1">
                    <li>• Uw aanbetaling wordt bevestigd</li>
