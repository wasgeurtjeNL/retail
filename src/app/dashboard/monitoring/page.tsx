...
export default function MonitoringPage() {
  const [activeTab, setActiveTab] = useState<'wasstrips' | 'cache'>('wasstrips');
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="mt-2 text-gray-600">Real-time monitoring van order workflow, cache performance en system health</p>
              </div>
              {activeTab === 'wasstrips' && (
